...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="sidebar">
            ...
            <ul class="list-unstyled component m-0">
                ...
                <li class="active">
		            <a href="#"><i class="material-icons">local_shipping</i>Exit Items</a>
		        </li>
                <li class="dropdown">
				            ...
				            <div class="table-title card mb-4">
				                <div class="row">
					                <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
						                <h2 class="ml-lg-2">Exit Items</h2>
						            </div>
						            <div class="col-sm-6 p-0 flex justify-content-lg-end justify-content-center">
						                <a href="#additemmodal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i><span>Add Exit Item</span></a>
    ...
    <div class="modal fade" tabindex="-1" id="additemmodal" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Exit Item</h5>
                    <button type="reset" class="reset-btn" hidden>Reset</button>
                    <button type="button" class="close reset" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
    ...
    <div class="modal fade" id="edititemmodal">
        <div class="modal-dialog">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h5 class="modal-title">Edit Exit Item "<b id="editExitItemName"></b>"</h5>
                    <button type="reset" class="reset-btn" hidden>Reset</button>
                ...
                <form id="submitedititemform">
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="outidedit">
                    </div>
                    <div class="modal-footer">
                        <button type="reset" class="reset-btn" hidden>Reset</button>
                        <button type="button" class="btn btn-secondary reset" data-dismiss="modal">Cancel</button>
    ...
    <div class="modal fade" id="deleteitemmodal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Delete Exit Item</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>

                <form id="submitdeleteitemform">
                    <div class="modal-body">
                    <p>Are you sure you want to delete "<b id="reqoutitemid"></b>" ?</p>
                    <p class="text-warning"><small>this action Cannot be Undone</small></p>
                    <input type="hidden" id="itemiddel">
                    <input type="hidden" id="outiddel">
    ...
    <script type="text/javascript">
        ...
        $('#submitadditemform').submit(function (e) {
            ...
            $.ajax({
                ...
                type: 'post',
                data: {
                    itemExitIdSend : itemIdAdd,
                    receiverExitNameSend : receiverNameAdd,
                    qtyExitSend : qtyAdd
                },
                success: function(data, status) {
                    $('#alert').html(data);
        ...
        // Edit Exit Item Function
        function getItem(itemid, outid) {
            $('#itemidedit').val(itemid);
            $('#outidedit').val(outid);

            $.post("../function.php", {
                itemidExitSend: itemid,
                outidExitSend: outid 
            },
            function(data, status) {
                var exititemid = JSON.parse(data);
                $('#editExitItemName').html(exititemid.itemname);
                $('#receivernameedit').val(exititemid.receivername);
                $('#qtyedit').val(exititemid.qty);
            });
        ...
        $('#submitedititemform').submit(function (e) {
            ...
            var outidUpdate = $('#outidedit').val();

            $.post("../function.php", {
                receiverExitNameEditSend: receivernameEdit,
                qtyExitEditSend: qtyEdit,
                itemidExitUpdateSend: itemidupdate,
                outidExitUpdateSend: outidUpdate
            }, function(data, status) {
                $('#alert').html(data);
        ...
        // Delete Exit Item Function
        function deleteItem(itemid, outid, qty) {
            ...
            $.post("../function.php", {
                ...
                $('#reqoutitemid').html(getDelItem.itemname);
            });
        ...
        $('#submitdeleteitemform').submit(function (e) {
            ...
            var hiddenoutidDel = $('#outiddel').val();
            var hiddenqtyDel = $('#inqtydel').val();

            $.post("../function.php", {
                hiddenitemidDelSend: hiddenitemidDel,
                hiddenoutidDelSend: hiddenoutidDel,
        ...
        $('#frm-example').on('submit', function(e) {
            ...
            $.ajax({
                url: '../function.php',
                type: 'post',
                data: {selectedExitArray: selected_array},
                success: function(data, status) {
