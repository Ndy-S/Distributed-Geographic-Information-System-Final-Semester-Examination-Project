            ...
            <ul class="list-unstyled component m-0">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="show list-unstyled menu" id="homeSubmenu1">
			            ...
			            <li class="active"><a href="#">Transaction Database</a></li>
		            </ul>
		        </li>
                <li>
				            ...
				            <div class="table-title card mb-4">
				                <div class="row">
					                <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
						                <h2 class="ml-lg-2">Transaction Database</h2>
						            </div>
                                    <div class="col-sm-6 p-0 flex justify-content-lg-end justify-content-center">
						                <a href="export.php" target="_blank" class="btn btn-primary"><i class="material-icons">print</i><span>Export</span></a>
                                    </div>
				                </div>
				            </div>
                        </div>
                ...
                <table id="example" class="table table-striped table-hover">
                    ...
                    <?php
                        ...
                        while ($data = mysqli_fetch_array($getallitem)) {
                            ...
                            <td><?=$req;?></td>
                            <td><?=$returned;?></td>
                            <td><?php if (empty($address)) {echo 'None';} else {echo $address;}?></td>
                            <td><?=$borrowdate;?></td>
                            ...
                            <td>
                                <?php
                                    if ($status == 0) {
                                        ...
                                        echo "Courier On The Way to Location";
                                    } else {
                                        echo "System Error";
                                    }
                                ?>
